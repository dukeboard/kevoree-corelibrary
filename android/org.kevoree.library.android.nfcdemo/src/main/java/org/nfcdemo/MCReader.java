...
public class MCReader {
    ...
    /**
     * Get new instance of {@link org.daum.library.nfcdemo.MCReader}.
     * If the tag is "null" or if it is not a Mifare Classic tag, "null"
     * will be returned.
     * @param tag The tag to operate on.
     * @return {@link org.daum.library.nfcdemo.MCReader} object or "null" if tag is "null" or tag is
     * not Mifare Classic.
     */
     ...
     * the given key file ({@link #setKeyFile(java.io.File[])}). If you want a
